...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="EN16931" id="UBL-EN16931">
  ...
  <param name="UBL-DT-01" value="true()"/>
  <param name="UBL-DT-02" value="true()"/>
  <param name="UBL-DT-03" value="true()"/>
  <param name="UBL-DT-04" value="true()"/>
  ...
  <param name="Amount_data_type" value="//*[ends-with(name(), 'Amount')]"/>
