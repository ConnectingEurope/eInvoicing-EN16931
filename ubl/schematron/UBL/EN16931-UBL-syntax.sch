...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="syntax" id="UBL-syntax">
  ...
  <param name="UBL-SR-43" value="(((name(/*) = 'Invoice') and (cbc:DocumentTypeCode='130')) or ((name(/*) = 'CreditNote') and (cbc:DocumentTypeCode='50')) or (not(cbc:ID/@scheme) and not(cbc:DocumentTypeCode)))"/>
