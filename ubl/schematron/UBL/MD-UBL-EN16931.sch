...
<!-- Timestamp: 2016-06-08 20:57:16 +0200 -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="EN16931" id="UBL-EN16931">
  ...
  <param name="BR-54" value="string-length(cbc:PrimaryAccountNumberID)&gt;4"/>
  <param name="BR-55" value="(cbc:ID)"/>
  <param name="BR-56" value="(cbc:DocumentType)"/>
  <param name="BR-57" value="(cbc:TaxInclusiveAmount) &gt;=0"/>
  <param name="BR-59" value="not(/ubl:Invoice/cbc:TaxCurrencyCode) or ((cbc:TaxCurrencyCode != cbc:DocumentCurrencyCode) and (//cbc:TransactionCurrencyTaxAmount))"/>
