...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-E-03" value="(//cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID)"/>
  <param name="BR-E-04" value="(//cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID)"/>
  ...
  <param name="BR-AE-01" value="((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'AE'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'AE'])) or not((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'AE'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'AE']))"/>
