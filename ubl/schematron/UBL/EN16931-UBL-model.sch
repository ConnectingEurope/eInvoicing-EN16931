...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-56" value="exists(cac:PartyTaxScheme[cac:TaxScheme/cbc:ID = 'VA']/cbc:CompanyID)"/>
  ...
  <param name="VAT_identifiers " value="//cac:PartyTaxScheme[cac:TaxScheme='VA']"/>
