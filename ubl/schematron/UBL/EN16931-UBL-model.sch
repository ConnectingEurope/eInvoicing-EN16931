...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-CO-12" value="cbc:AllowanceTotalAmount = (round(sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true']/xs:decimal(cbc:Amount)) * 10 * 10) div 100) or not(cbc:AllowanceTotalAmount)"/>
  ...
  <param name="BR-S-01" value="((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'S'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'S'])) or not((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'S'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'S']))"/>
  ...
  <param name="BR-Z-01" value="((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'Z'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'Z'])) or not((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'Z'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'Z']))"/>
  ...
  <param name="BR-Z-06" value="../cbc:TaxableAmount = sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='Z']/xs:decimal(cbc:LineExtensionAmount)) + sum(//cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator='true']/xs:decimal(cbc:Amount)) - sum(//cac:InvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator='false']/xs:decimal(cbc:Amount))"/>
  ...
  <param name="BR-E-01" value="((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'E'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'E'])) or not((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'E'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'E']))"/>
  ...
  <param name="BR-IC-01" value="((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'IC'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'IC'])) or not((exists(cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cbc:ID[. = 'IC'])) and (cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID[. = 'IC']))"/>
