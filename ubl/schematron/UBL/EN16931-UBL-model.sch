...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-50" value="exists(//cac:PartyIdentification/cbc:ID[@schemeID='SEPA'])"/>
  ...
  <param name="BR-53" value="let $taxcurrency:=cbc:TaxCurrencyCode return (exists(cbc:TaxCurrencyCode) and (exists(cac:TaxTotal/cbc:TaxAmount[@currencyID=$taxcurrency])))&#10;or&#10;(not(exists(cbc:TaxCurrencyCode)))"/>
