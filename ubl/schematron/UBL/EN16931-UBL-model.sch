...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-17" value="exists(cac:PartyName/cbc:Name) and (compare(cac:PartyName/cbc:Name,/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName) = 0)"/>
  ...
  <param name="BR-34" value="(cbc:Amount) &gt;=0"/>
  <param name="BR-35" value="(cbc:BaseAmount) &gt;=0 or not(cbc:BaseAmount)"/>
  ...
  <param name="BR-39" value="(cbc:Amount) &gt;=0"/>
  <param name="BR-40" value="(cbc:BaseAmount) &gt;=0 or not(cbc:BaseAmount)"/>
  ...
  <param name="BR-51" value="number(substring(cbc:PrimaryAccountNumberID,string-length(cbc:PrimaryAccountNumberID)-4)) = number(substring(cbc:PrimaryAccountNumberID,string-length(cbc:PrimaryAccountNumberID)-4))"/>
  <param name="BR-52" value="exists(cbc:ID)"/>
  <param name="BR-53" value="(exists(cbc:TaxCurrencyCode) and exists(cbc:DocumentCurrencyCode) and (cbc:TaxCurrencyCode) != (cbc:DocumentCurrencyCode) and exists(//cbc:TransactionCurrencyTaxAmount))&#10;or&#10;(not(exists(cbc:TaxCurrencyCode)))&#10;or &#10;(exists(cbc:TaxCurrencyCode) and exists(cbc:DocumentCurrencyCode) and (cbc:TaxCurrencyCode) = (cbc:DocumentCurrencyCode))&#10;or&#10;(exists(cbc:TaxCurrencyCode) and exists(cbc:DocumentCurrencyCode) and not(exists(//cbc:TransactionCurrencyTaxAmount)))"/>
  <param name="BR-54" value="exists(cbc:Name) and exists(cbc:Value)"/>
  <param name="BR-55" value="exists(cbc:ID)"/>
  <param name="BR-CO-01" value="count(//cac:AccountingSupplierParty/cac:Party/cac:Language/cbc:LocaleCode) &lt;=1"/>
  <param name="BR-CO-02" value="((cbc:PaymentMeansCode = '30') and (cac:PayeeFinancialAccount/cbc:ID)) or not(cbc:PaymentMeansCode =  '30')"/>
  <param name="BR-CO-03" value="(exists(cbc:TaxPointDate) and not(cbc:AccountingCostCode)) or (exists(cbc:TaxPointDate) and not(cbc:AccountingCostCode)) or (not(cbc:TaxPointDate) and not(cbc:AccountingCostCode))"/>
  ...
  <param name="BR-CO-18" value="exists(cac:TaxTotal)"/>
  ...
  <param name="BR-CO-25" value="(number(cac:LegalMonetaryTotal/cbc:PayableAmount) &gt; 0 and (exists(cbc:DueDate) or exists(cac:PaymentTerms/cbc:Note))) or not(number(cac:LegalMonetaryTotal/cbc:PayableAmount)&gt;0)"/>
  ...
  <param name="BR-S-08" value="every $rate in cbc:Percent satisfies(../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='S'][cac:Item/cac:ClassifiedTaxCategory/cbc:Percent =$rate]/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='S'][cac:TaxCategory/cbc:Percent = $rate]/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='S'][cac:TaxCategory/cbc:Percent = $rate]/xs:decimal(cbc:Amount))))"/>
  ...
  <param name="BR-Z-08" value="../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='Z']/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='Z']/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='Z']/xs:decimal(cbc:Amount)))"/>
  ...
  <param name="BR-E-08" value="../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='E']/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='E']/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='E']/xs:decimal(cbc:Amount)))"/>
  ...
  <param name="BR-AE-01" value="((exists(//cac:TaxCategory/cbc:ID[. = 'AE']) or exists(//cac:ClassifiedTaxCategory/cbc:ID[. = 'AE'])) and (count(//cac:TaxCategory/cbc:ID[. != 'AE']) = 0 and count(//cac:ClassifiedTaxCategory/cbc:ID[. != 'AE'])=0)) or (count(//cac:TaxCategory/cbc:ID[. = 'AE']) = 0 and count(//cac:ClassifiedTaxCategory/cbc:ID[. = 'AE'])=0)"/>
  ...
  <param name="BR-AE-08" value="../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='AE']/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='AE']/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='AE']/xs:decimal(cbc:Amount)))"/>
  ...
  <param name="BR-IC-08" value="../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='IC']/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='IC']/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='IC']/xs:decimal(cbc:Amount)))"/>
  ...
  <param name="BR-G-08" value="../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='G']/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='G']/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='G']/xs:decimal(cbc:Amount)))"/>
  ...
  <param name="BR-O-08" value="../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='O']/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='O']/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='O']/xs:decimal(cbc:Amount)))"/>
  ...
  <param name="BR-IG-08" value="every $rate in cbc:Percent satisfies (../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='IG'][cac:Item/cac:ClassifiedTaxCategory/cbc:Percent =$rate]/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='IG'][cac:TaxCategory/cbc:Percent = $rate]/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='IG'][cac:TaxCategory/cbc:Percent = $rate]/xs:decimal(cbc:Amount))))"/>
  ...
  <param name="BR-IP-08" value="every $rate in cbc:Percent satisfies(../cbc:TaxableAmount = (sum(//cac:InvoiceLine[cac:Item/cac:ClassifiedTaxCategory/cbc:ID='IP'][cac:Item/cac:ClassifiedTaxCategory/cbc:Percent =$rate]/xs:decimal(cbc:LineExtensionAmount)) + sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='true'][cac:TaxCategoryCode/cbc:ID='IP'][cac:TaxCategory/cbc:Percent = $rate]/xs:decimal(cbc:Amount)) - sum(/ubl:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator='false'][cac:TaxCategoryCode/cbc:ID='IP'][cac:TaxCategory/cbc:Percent = $rate]/xs:decimal(cbc:Amount))))"/>
  ...
  <param name="Preceding_Invoice" value="cac:BillingReference/cac:InvoiceDocumentReference"/>
