...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-61" value="(exists(cac:PayeeFinancialAccount/cbc:ID) and ((cbc:PaymentMeansCode = '30') or (cbc:PaymentMeansCode = '57') )) or ((cbc:PaymentMeansCode != '30') and (cbc:PaymentMeansCode != '57'))"/>
  ...
  <param name="BR-AE-01" value="((exists(//cac:TaxCategory/cbc:ID[. = 'AE']) or exists(//cac:ClassifiedTaxCategory/cbc:ID[. = 'AE'])) and (count(//cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID) = 1) and (count(//cac:TaxCategory/cbc:ID[. != 'AE']) = 0 and count(//cac:ClassifiedTaxCategory/cbc:ID[. != 'AE'])=0)) or (count(//cac:TaxCategory/cbc:ID[. = 'AE']) = 0 and count(//cac:ClassifiedTaxCategory/cbc:ID[. = 'AE'])=0)"/>
