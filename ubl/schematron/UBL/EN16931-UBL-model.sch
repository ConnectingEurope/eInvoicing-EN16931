...
<!-- Timestamp: 2016-11-29 20:18:43 +0100 -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="model" id="UBL-model">
  ...
  <param name="BR-61" value="(exists(cac:PayeeFinancialAccount/cbc:ID) and (cbc:PaymentMeansCode = '30'))  or not( cbc:PaymentMeansCode = '30')"/>
  ...
  <param name="BR-CO-15" value="(cbc:TaxInclusiveAmount = cbc:TaxExclusiveAmount + (round(sum(//cac:TaxTotal/xs:decimal(cbc:TaxAmount)) * 10 * 10) div 100))"/>
