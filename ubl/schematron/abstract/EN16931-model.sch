...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="model">
  ...
  <rule context="$Invoice ">
    ...
    <assert test="$BR-58" flag="fatal" id="BR-58">[BR-58]-If the preceding invoice issue date (BT-26) is present, then it shall be prior to the Invoice issue date (BT-2).</assert>
