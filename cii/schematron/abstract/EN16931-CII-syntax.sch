...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="EN16931-CII">
	...
	<rule context="$ApplicableHeaderTradeAgreement">
		...
		<assert test="$CII-SR-298" flag="warning" id="CII-SR-298">[CII-SR-298] - LineID should not
			be present</assert>
		<assert test="$CII-SR-299" flag="warning" id="CII-SR-299">[CII-SR-299] -
			DemandForecastReferencedDocument should not be present</assert>
		<assert test="$CII-SR-300" flag="warning" id="CII-SR-300">[CII-SR-300] -
			SupplyInstructionReferencedDocument should not be present</assert>
		<assert test="$CII-SR-301" flag="warning" id="CII-SR-301">[CII-SR-301] -
			PromotionalDealReferencedDocument should not be present</assert>
		<assert test="$CII-SR-302" flag="warning" id="CII-SR-302">[CII-SR-302] -
			PriceListReferencedDocument should not be present</assert>
		<assert test="$CII-SR-303" flag="warning" id="CII-SR-303">[CII-SR-303] - LineID should not
			be present</assert>
		<assert test="$CII-SR-304" flag="warning" id="CII-SR-304">[CII-SR-304] -
			RequisitionerReferencedDocument should not be present</assert>
		<assert test="$CII-SR-305" flag="warning" id="CII-SR-305">[CII-SR-305] -
			BuyerAgentTradeParty should not be present</assert>
		<assert test="$CII-SR-306" flag="warning" id="CII-SR-306">[CII-SR-306] -
			PurchaseConditionsReferencedDocument should not be present</assert>
		<assert test="$CII-SR-307" flag="warning" id="CII-SR-307">[CII-SR-307] - Description should
			not be present</assert>
		<assert test="$CII-SR-448" flag="warning" id="CII-SR-448">[CII-SR-448] -
			UltimateCustomerOrderReferencedDocument should not be present</assert>
		<assert test="$CII-SR-450" flag="warning" id="CII-SR-450">[CII-SR-450] - Only one buyer
			identifier should be present (either the ID or the Global ID)</assert>
		<assert test="$CII-SR-459" flag="warning" id="CII-SR-459">[CII-SR-459] - SellerTradeParty
			URIUniversalCommunication should exist maximum once</assert>
		<assert test="$CII-SR-460" flag="warning" id="CII-SR-460">[CII-SR-460] - BuyerTradeParty
			URIUniversalCommunication should exist maximum once</assert>
	</rule>
	<rule context="$ApplicableHeaderTradeDelivery">
		<assert test="$CII-SR-308" flag="warning" id="CII-SR-308">[CII-SR-308] -
			RelatedSupplyChainConsignment should not be present</assert>
		<assert test="$CII-SR-309" flag="warning" id="CII-SR-309">[CII-SR-309] - RoleCode should not
			be present</assert>
		<assert test="$CII-SR-310" flag="warning" id="CII-SR-310">[CII-SR-310] - Description should
			not be present</assert>
		<assert test="$CII-SR-311" flag="warning" id="CII-SR-311">[CII-SR-311] -
			SpecifiedLegalOrganization should not be present</assert>
		<assert test="$CII-SR-312" flag="warning" id="CII-SR-312">[CII-SR-312] - DefinedTradeContact
			should not be present</assert>
		<assert test="$CII-SR-313" flag="warning" id="CII-SR-313">[CII-SR-313] -
			URIUniversalCommunication should not be present</assert>
		<assert test="$CII-SR-314" flag="warning" id="CII-SR-314">[CII-SR-314] -
			SpecifiedTaxRegistration should not be present</assert>
		<assert test="$CII-SR-315" flag="warning" id="CII-SR-315">[CII-SR-315] -
			EndPointURIUniversalCommunication should not be present</assert>
		<assert test="$CII-SR-316" flag="warning" id="CII-SR-316">[CII-SR-316] -
			LogoAssociatedSpecifiedBinaryFile should not be present</assert>

		<assert test="$CII-SR-317" flag="warning" id="CII-SR-317">[CII-SR-317] -
			UltimateShipToTradeParty should not be present</assert>
		<assert test="$CII-SR-318" flag="warning" id="CII-SR-318">[CII-SR-318] - ShipFromTradeParty
			should not be present</assert>
		<assert test="$CII-SR-319" flag="warning" id="CII-SR-319">[CII-SR-319] -
			ActualDespatchSupplyChainEvent should not be present</assert>
		<assert test="$CII-SR-320" flag="warning" id="CII-SR-320">[CII-SR-320] -
			ActualPickUpSupplyChainEvent should not be present</assert>

		<assert test="$CII-SR-321" flag="warning" id="CII-SR-321">[CII-SR-321] - ID should not be
			present</assert>
		<assert test="$CII-SR-322" flag="warning" id="CII-SR-322">[CII-SR-322] - DateTime should not
			be present</assert>
		<assert test="$CII-SR-323" flag="warning" id="CII-SR-323">[CII-SR-323] - TypeCode should not
			be present</assert>
		<assert test="$CII-SR-324" flag="warning" id="CII-SR-324">[CII-SR-324] - Description should
			not be present</assert>
		<assert test="$CII-SR-325" flag="warning" id="CII-SR-325">[CII-SR-325] -
			DescriptionBinaryObject should not be present</assert>
		<assert test="$CII-SR-326" flag="warning" id="CII-SR-326">[CII-SR-326] - UnitQuantity should
			not be present</assert>
		<assert test="$CII-SR-327" flag="warning" id="CII-SR-327">[CII-SR-327] -
			LatestOccurrenceDateTime should not be present</assert>
		<assert test="$CII-SR-328" flag="warning" id="CII-SR-328">[CII-SR-328] -
			EarliestOccurrenceDateTime should not be present</assert>
		<assert test="$CII-SR-329" flag="warning" id="CII-SR-329">[CII-SR-329] -
			OccurrenceSpecifiedPeriod should not be present</assert>
		<assert test="$CII-SR-330" flag="warning" id="CII-SR-330">[CII-SR-330] -
			OccurrenceLogisticsLocation should not be present</assert>

		<assert test="$CII-SR-331" flag="warning" id="CII-SR-331">[CII-SR-331] -
			ActualReceiptSupplyChainEvent should not be present</assert>
		<assert test="$CII-SR-332" flag="warning" id="CII-SR-332">[CII-SR-332] -
			AdditionalReferencedDocument should not be present</assert>
		<assert test="$CII-SR-333" flag="warning" id="CII-SR-333">[CII-SR-333] - LineID should not
			be present</assert>
		<assert test="$CII-SR-334" flag="warning" id="CII-SR-334">[CII-SR-334] - LineID should not
			be present</assert>
		<assert test="$CII-SR-335" flag="warning" id="CII-SR-335">[CII-SR-335] -
			DeliveryNoteReferencedDocument should not be present</assert>
		<assert test="$CII-SR-336" flag="warning" id="CII-SR-336">[CII-SR-336] -
			ConsumptionReportReferencedDocument should not be present</assert>
		<assert test="$CII-SR-337" flag="warning" id="CII-SR-337">[CII-SR-337] -
			PreviousDeliverySupplyChainEvent should not be present</assert>
		<assert test="$CII-SR-338" flag="warning" id="CII-SR-338">[CII-SR-338] -
			PackingListReferencedDocument should not be present</assert>
		<assert test="$CII-SR-449" flag="warning" id="CII-SR-449">[CII-SR-449] - Only one delivery
	...
	<rule context="$ApplicableHeaderTradeSettlement">
		<assert test="$CII-SR-339" flag="warning" id="CII-SR-339">[CII-SR-339] - DuePayableAmount
			should not be present</assert>
		<assert test="$CII-SR-340" flag="warning" id="CII-SR-340">[CII-SR-340] -
			CreditorReferenceTypeCode should not be present</assert>
		<assert test="$CII-SR-341" flag="warning" id="CII-SR-341">[CII-SR-341] -
			CreditorReferenceType should not be present</assert>
		<assert test="$CII-SR-342" flag="warning" id="CII-SR-342">[CII-SR-342] -
			CreditorReferenceIssuerID should not be present</assert>

		<assert test="$CII-SR-344" flag="warning" id="CII-SR-344">[CII-SR-344] - PaymentCurrencyCode
			should not be present</assert>
		<assert test="$CII-SR-345" flag="warning" id="CII-SR-345">[CII-SR-345] -
			InvoiceIssuerReference should not be present</assert>
		<assert test="$CII-SR-346" flag="warning" id="CII-SR-346">[CII-SR-346] - InvoiceDateTime
			should not be present</assert>
		<assert test="$CII-SR-347" flag="warning" id="CII-SR-347">[CII-SR-347] - NextInvoiceDateTime
			should not be present</assert>
		<assert test="$CII-SR-348" flag="warning" id="CII-SR-348">[CII-SR-348] - CreditReasonCode
			should not be present</assert>
		<assert test="$CII-SR-349" flag="warning" id="CII-SR-349">[CII-SR-349] - CreditReason should
			not be present</assert>
		<assert test="$CII-SR-350" flag="warning" id="CII-SR-350">[CII-SR-350] - InvoicerTradeParty
			should not be present</assert>
		<assert test="$CII-SR-351" flag="warning" id="CII-SR-351">[CII-SR-351] - InvoiceeTradeParty
			should not be present</assert>

		<assert test="$CII-SR-352" flag="warning" id="CII-SR-352">[CII-SR-352] - RoleCode should not
			be present</assert>
		<assert test="$CII-SR-353" flag="warning" id="CII-SR-353">[CII-SR-353] - Description should
			not be present</assert>
		<assert test="$CII-SR-354" flag="warning" id="CII-SR-354">[CII-SR-354] -
			LegalClassificationCode should not be present</assert>
		<assert test="$CII-SR-355" flag="warning" id="CII-SR-355">[CII-SR-355] - Name should not be
			present</assert>
		<assert test="$CII-SR-356" flag="warning" id="CII-SR-356">[CII-SR-356] - TradingBusinessName
			should not be present</assert>
		<assert test="$CII-SR-357" flag="warning" id="CII-SR-357">[CII-SR-357] - PostalTradeAddress
			should not be present</assert>
		<assert test="$CII-SR-358" flag="warning" id="CII-SR-358">[CII-SR-358] -
			AuthorizedLegalRegistration should not be present</assert>
		<assert test="$CII-SR-359" flag="warning" id="CII-SR-359">[CII-SR-359] - DefinedTradeContact
			should not be present</assert>
		<assert test="$CII-SR-360" flag="warning" id="CII-SR-360">[CII-SR-360] - PostalTradeAddress
			should not be present</assert>
		<assert test="$CII-SR-361" flag="warning" id="CII-SR-361">[CII-SR-361] -
			URIUniversalCommunication should not be present</assert>
		<assert test="$CII-SR-362" flag="warning" id="CII-SR-362">[CII-SR-362] -
			SpecifiedTaxRegistration should not be present</assert>
		<assert test="$CII-SR-363" flag="warning" id="CII-SR-363">[CII-SR-363] -
			EndPointURIUniversalCommunication should not be present</assert>
		<assert test="$CII-SR-364" flag="warning" id="CII-SR-364">[CII-SR-364] -
			LogoAssociatedSpecifiedBinaryFile should not be present</assert>
		<assert test="$CII-SR-451" flag="warning" id="CII-SR-451">[CII-SR-451] - Only one payee
			identifier should be present (either the ID or the Global ID)</assert>

		<assert test="$CII-SR-365" flag="warning" id="CII-SR-365">[CII-SR-365] - PayerTradeParty
			should not be present</assert>
		<assert test="$CII-SR-366" flag="warning" id="CII-SR-366">[CII-SR-366] -
			TaxApplicableTradeCurrencyExchange should not be present</assert>
		<assert test="$CII-SR-367" flag="warning" id="CII-SR-367">[CII-SR-367] -
			InvoiceApplicableTradeCurrencyExchange should not be present</assert>
		<assert test="$CII-SR-368" flag="warning" id="CII-SR-368">[CII-SR-368] -
			PaymentApplicableTradeCurrencyExchange should not be present</assert>

		<assert test="$CII-SR-369" flag="warning" id="CII-SR-369">[CII-SR-369] - PaymentChannelCode
			should not be present</assert>
		<assert test="$CII-SR-370" flag="warning" id="CII-SR-370">[CII-SR-370] - GuaranteeMethodCode
			should not be present</assert>
		<assert test="$CII-SR-371" flag="warning" id="CII-SR-371">[CII-SR-371] - PaymentMethodCode
			should not be present</assert>
		<assert test="$CII-SR-443" flag="warning" id="CII-SR-443">[CII-SR-443] - ID should not be
			present</assert>
		<assert test="$CII-SR-372" flag="warning" id="CII-SR-372">[CII-SR-372] - MicrochipIndicator
			should not be present</assert>
		<assert test="$CII-SR-373" flag="warning" id="CII-SR-373">[CII-SR-373] - TypeCode should not
			be present</assert>

		<assert test="$CII-SR-375" flag="warning" id="CII-SR-375">[CII-SR-375] - ExpiryDate should
			not be present</assert>
		<assert test="$CII-SR-376" flag="warning" id="CII-SR-376">[CII-SR-376] - VerificationNumeric
			should not be present</assert>
		<assert test="$CII-SR-377" flag="warning" id="CII-SR-377">[CII-SR-377] - ValidFromDateTime
			should not be present</assert>
		<assert test="$CII-SR-378" flag="warning" id="CII-SR-378">[CII-SR-378] - CreditLimitAmount
			should not be present</assert>
		<assert test="$CII-SR-379" flag="warning" id="CII-SR-379">[CII-SR-379] -
			CreditAvailableAmount should not be present</assert>
		<assert test="$CII-SR-380" flag="warning" id="CII-SR-380">[CII-SR-380] - InterestRatePercent
			should not be present</assert>
		<assert test="$CII-SR-381" flag="warning" id="CII-SR-381">[CII-SR-381] - Description should
			not be present</assert>
		<assert test="$CII-SR-382" flag="warning" id="CII-SR-382">[CII-SR-382] - AccountName should
			not be present</assert>
		<assert test="$CII-SR-444" flag="warning" id="CII-SR-444">[CII-SR-444] - ProprietaryID
			should not be present</assert>

		<assert test="$CII-SR-384" flag="warning" id="CII-SR-384">[CII-SR-384] - ClearingSystemName
			should not be present</assert>
		<assert test="$CII-SR-385" flag="warning" id="CII-SR-385">[CII-SR-385] - Name should not be
			present</assert>
		<assert test="$CII-SR-386" flag="warning" id="CII-SR-386">[CII-SR-386] -
			LocationFinancialInstitutionAddress should not be present</assert>


		<assert test="$CII-SR-388" flag="warning" id="CII-SR-388">[CII-SR-388] - ID should not be
			present</assert>
		<assert test="$CII-SR-389" flag="warning" id="CII-SR-389">[CII-SR-389] - SequenceNumeric
			should not be present</assert>
		<assert test="$CII-SR-390" flag="warning" id="CII-SR-390">[CII-SR-390] - BasisQuantity
			should not be present</assert>
		<assert test="$CII-SR-391" flag="warning" id="CII-SR-391">[CII-SR-391] - PrepaidIndicator
			should not be present</assert>
		<assert test="$CII-SR-392" flag="warning" id="CII-SR-392">[CII-SR-392] - UnitBasisAmount
			should not be present</assert>
		<assert test="$CII-SR-393" flag="warning" id="CII-SR-393">[CII-SR-393] - TypeCode should not
			be present</assert>
		<assert test="$CII-SR-394" flag="warning" id="CII-SR-394">[CII-SR-394] -
			ActualTradeCurrencyExchange should not be present</assert>
		<assert test="$CII-SR-395" flag="warning" id="CII-SR-395">[CII-SR-395] -
			SubtotalCalculatedTradeTax should not be present</assert>
		<assert test="$CII-SR-396" flag="warning" id="CII-SR-396">[CII-SR-396] -
			SpecifiedLogisticsServiceCharge should not be present</assert>

		<assert test="$CII-SR-397" flag="warning" id="CII-SR-397">[CII-SR-397] - ID should not be
			present</assert>
		<assert test="$CII-SR-398" flag="warning" id="CII-SR-398">[CII-SR-398] - FromEventCode
			should not be present</assert>
		<assert test="$CII-SR-399" flag="warning" id="CII-SR-399">[CII-SR-399] -
			SettlementPeriodMeasure should not be present</assert>
		<assert test="$CII-SR-400" flag="warning" id="CII-SR-400">[CII-SR-400] - DateTime should not
			be present</assert>
		<assert test="$CII-SR-401" flag="warning" id="CII-SR-401">[CII-SR-401] - TypeCode should not
			be present</assert>
		<assert test="$CII-SR-402" flag="warning" id="CII-SR-402">[CII-SR-402] - InstructionTypeCode
			should not be present</assert>

		<assert test="$CII-SR-404" flag="warning" id="CII-SR-404">[CII-SR-404] -
			PartialPaymentPercent should not be present</assert>
		<assert test="$CII-SR-405" flag="warning" id="CII-SR-405">[CII-SR-405] - PaymentMeansID
			should not be present</assert>
		<assert test="$CII-SR-406" flag="warning" id="CII-SR-406">[CII-SR-406] -
			PartialPaymentAmount should not be present</assert>
		<assert test="$CII-SR-407" flag="warning" id="CII-SR-407">[CII-SR-407] -
			ApplicableTradePaymentPenaltyTerms should not be present</assert>
		<assert test="$CII-SR-408" flag="warning" id="CII-SR-408">[CII-SR-408] -
			ApplicableTradePaymentDiscountTerms should not be present</assert>
		<assert test="$CII-SR-409" flag="warning" id="CII-SR-409">[CII-SR-409] - PayeeTradeParty
			should not be present</assert>

		<assert test="$CII-SR-421" flag="warning" id="CII-SR-421">[CII-SR-421] -
			SpecifiedFinancialAdjustment should not be present</assert>
		<assert test="$CII-SR-422" flag="warning" id="CII-SR-422">[CII-SR-422] - LineID should not
			be present</assert>
		<assert test="$CII-SR-423" flag="warning" id="CII-SR-423">[CII-SR-423] -
			ProFormaInvoiceReferencedDocument should not be present</assert>
		<assert test="$CII-SR-424" flag="warning" id="CII-SR-424">[CII-SR-424] -
			LetterOfCreditReferencedDocument should not be present</assert>
		<assert test="$CII-SR-425" flag="warning" id="CII-SR-425">[CII-SR-425] -
			FactoringAgreementReferencedDocument should not be present</assert>
		<assert test="$CII-SR-426" flag="warning" id="CII-SR-426">[CII-SR-426] -
			FactoringListReferencedDocument should not be present</assert>
		<assert test="$CII-SR-427" flag="warning" id="CII-SR-427">[CII-SR-427] -
			PayableSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-SR-428" flag="warning" id="CII-SR-428">[CII-SR-428] - SetTriggerCode
			should not be present</assert>
		<assert test="$CII-SR-429" flag="warning" id="CII-SR-429">[CII-SR-429] - TypeCode should not
			be present</assert>
		<assert test="$CII-SR-430" flag="warning" id="CII-SR-430">[CII-SR-430] - AmountTypeCode
			should not be present</assert>
		<assert test="$CII-SR-431" flag="warning" id="CII-SR-431">[CII-SR-431] - Name should not be
			present</assert>
		<assert test="$CII-SR-432" flag="warning" id="CII-SR-432">[CII-SR-432] -
			CostReferenceDimensionPattern should not be present</assert>
		<assert test="$CII-SR-433" flag="warning" id="CII-SR-433">[CII-SR-433] -
			PurchaseSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-SR-434" flag="warning" id="CII-SR-434">[CII-SR-434] -
			SalesSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-SR-435" flag="warning" id="CII-SR-435">[CII-SR-435] -
			SpecifiedTradeSettlementFinancialCard should not be present</assert>
		<assert test="$CII-SR-436" flag="warning" id="CII-SR-436">[CII-SR-436] -
			SpecifiedAdvancePayment should not be present</assert>
		<assert test="$CII-SR-437" flag="warning" id="CII-SR-437">[CII-SR-437] -
			UltimatePayeeTradeParty should not be present</assert>

	</rule>
	<rule context="$SpecifiedTradeSettlementHeaderMonetarySummation">

		<assert test="$CII-SR-411" flag="warning" id="CII-SR-411">[CII-SR-411] - InformationAmount
			should not be present</assert>
		<assert test="$CII-SR-412" flag="warning" id="CII-SR-412">[CII-SR-412] - TotalDiscountAmount
			should not be present</assert>
		<assert test="$CII-SR-413" flag="warning" id="CII-SR-413">[CII-SR-413] -
			TotalAllowanceChargeAmount should not be present</assert>
		<assert test="$CII-SR-414" flag="warning" id="CII-SR-414">[CII-SR-414] -
			RetailValueExcludingTaxInformationAmount should not be present</assert>
		<assert test="$CII-SR-415" flag="warning" id="CII-SR-415">[CII-SR-415] -
			TotalDepositFeeInformationAmount should not be present</assert>
		<assert test="$CII-SR-416" flag="warning" id="CII-SR-416">[CII-SR-416] -
			ProductValueExcludingTobaccoTaxInformationAmount should not be present</assert>
		<assert test="$CII-SR-417" flag="warning" id="CII-SR-417">[CII-SR-417] -
			TotalRetailValueInformationAmount should not be present</assert>
		<assert test="$CII-SR-418" flag="warning" id="CII-SR-418">[CII-SR-418] -
			GrossLineTotalAmount should not be present</assert>
		<assert test="$CII-SR-419" flag="warning" id="CII-SR-419">[CII-SR-419] - NetLineTotalAmount
			should not be present</assert>
		<assert test="$CII-SR-420" flag="warning" id="CII-SR-420">[CII-SR-420] -
			NetIncludingTaxesLineTotalAmount should not be present</assert>
	</rule>
	<rule context="$Invoice">
		<assert test="$CII-DT-013" flag="fatal" id="CII-DT-013">[CII-DT-013] - languageID should not
			be present</assert>
		<assert test="$CII-DT-014" flag="fatal" id="CII-DT-014">[CII-DT-014] - languageLocaleID
			should not be present</assert>

		<assert test="$CII-SR-438" flag="warning" id="CII-SR-438">[CII-SR-438] -
			ValuationBreakdownStatement should not be present</assert>
	</rule>
	<rule context="$DocumentContextParameter">
		<assert test="$CII-SR-004" flag="warning" id="CII-SR-04">[CII-SR-004] - Value should not be
			present</assert>
		<assert test="$CII-SR-005" flag="warning" id="CII-SR-05">[CII-SR-005] -
			SpecifiedDocumentVersion should not be present</assert>
	</rule>
	<rule context="$IDTypeNoAttributes">
		<assert test="$CII-DT-005" flag="fatal" id="CII-DT-005">[CII-DT-005] - schemeID should not
			be present</assert>
		<assert test="$CII-DT-006" flag="fatal" id="CII-DT-006">[CII-DT-006] - schemeAgencyID should
			not be present</assert>
		<assert test="$CII-DT-007" flag="fatal" id="CII-DT-007">[CII-DT-007] - schemeVersionID
			should not be present</assert>
	</rule>
	<rule context="$IDType">
		<assert test="$CII-DT-001" flag="fatal" id="CII-DT-001">[CII-DT-001] - schemeName should not
			be present</assert>
		<assert test="$CII-DT-002" flag="fatal" id="CII-DT-002">[CII-DT-002] - schemeAgencyName
			should not be present</assert>
		<assert test="$CII-DT-003" flag="fatal" id="CII-DT-003">[CII-DT-003] - schemeDataURI should
			not be present</assert>
		<assert test="$CII-DT-004" flag="fatal" id="CII-DT-004">[CII-DT-004] - schemeURI should not
			be present</assert>
	</rule>
	<rule context="$TypeCodeType">
		<assert test="$CII-DT-008" flag="fatal" id="CII-DT-008">[CII-DT-008] - name should not be
			present</assert>
	...
	<rule context="$NoAttributesTypeCodeType">
		...
		<assert test="$CII-DT-011" flag="fatal" id="CII-DT-011">[CII-DT-011] - listAgencyID should
			not be present</assert>
		<assert test="$CII-DT-012" flag="fatal" id="CII-DT-012">[CII-DT-012] - listVersionID should
			not be present</assert>
	</rule>
	...
	<rule context="$ReferencedDocumentType">
		<assert test="$CII-DT-015" flag="fatal" id="CII-DT-015">[CII-DT-015] - URIID should not be
			present</assert>
		<assert test="$CII-DT-016" flag="fatal" id="CII-DT-016">[CII-DT-016] - StatusCode should not
			be present</assert>
		<assert test="$CII-DT-017" flag="fatal" id="CII-DT-017">[CII-DT-017] - CopyIndicator should
			not be present</assert>
		<assert test="$CII-DT-018" flag="fatal" id="CII-DT-018">[CII-DT-018] - TypeCode should not
			be present</assert>
		<assert test="$CII-DT-019" flag="fatal" id="CII-DT-019">[CII-DT-019] - GlobalID should not
			be present</assert>
		<assert test="$CII-DT-020" flag="fatal" id="CII-DT-020">[CII-DT-020] - RevisionID should not
			be present</assert>
		<assert test="$CII-DT-021" flag="fatal" id="CII-DT-021">[CII-DT-021] - Name should not be
			present</assert>
		<assert test="$CII-DT-022" flag="fatal" id="CII-DT-022">[CII-DT-022] -
			AttachmentBinaryObject should not be present</assert>
		<assert test="$CII-DT-023" flag="fatal" id="CII-DT-023">[CII-DT-023] - Information should
			not be present</assert>
		<assert test="$CII-DT-024" flag="fatal" id="CII-DT-024">[CII-DT-024] - ReferenceTypeCode
			should not be present</assert>
		<assert test="$CII-DT-025" flag="fatal" id="CII-DT-025">[CII-DT-025] - SectionName should
			not be present</assert>
		<assert test="$CII-DT-026" flag="fatal" id="CII-DT-026">[CII-DT-026] - PreviousRevisionID
			should not be present</assert>
		<assert test="$CII-DT-027" flag="fatal" id="CII-DT-027">[CII-DT-027] -
			FormattedIssueDateTime should not be present</assert>
		<assert test="$CII-DT-028" flag="fatal" id="CII-DT-028">[CII-DT-028] -
			EffectiveSpecifiedPeriod should not be present</assert>
		<assert test="$CII-DT-029" flag="fatal" id="CII-DT-029">[CII-DT-029] - IssuerTradeParty
			should not be present</assert>
		<assert test="$CII-DT-030" flag="fatal" id="CII-DT-030">[CII-DT-030] -
			AttachedSpecifiedBinaryFile should not be present</assert>
	</rule>
	<rule context="$AmountType">
		<assert test="$CII-DT-031" flag="fatal" id="CII-DT-031">[CII-DT-031] - currencyID should not
			be present</assert>
		<assert test="$CII-DT-032" flag="fatal" id="CII-DT-032">[CII-DT-032] -
			currencyCodeListVersionID should not be present</assert>
	</rule>
	<rule context="$QuantityType">
		<assert test="$CII-DT-033" flag="fatal" id="CII-DT-033">[CII-DT-033] - unitCode should not
			be present</assert>
		<assert test="$CII-DT-034" flag="fatal" id="CII-DT-034">[CII-DT-034] - unitCodeListID should
			not be present</assert>
		<assert test="$CII-DT-035" flag="fatal" id="CII-DT-035">[CII-DT-035] - unitCodeListAgencyID
			should not be present</assert>
		<assert test="$CII-DT-036" flag="fatal" id="CII-DT-036">[CII-DT-036] -
			unitCodeListAgencyName should not be present</assert>
	</rule>
	<rule context="$TradeTaxType">
		<assert test="$CII-DT-037" flag="fatal" id="CII-DT-037">[CII-DT-037] - TypeCode shall be
			'VAT'</assert>
		<assert test="$CII-DT-038" flag="warning" id="CII-DT-038">[CII-DT-038] - CalculatedRate
			should not be present</assert>
		<assert test="$CII-DT-039" flag="warning" id="CII-DT-039">[CII-DT-039] -
			CalculationSequenceNumeric should not be present</assert>
		<assert test="$CII-DT-040" flag="warning" id="CII-DT-040">[CII-DT-040] - BasisQuantity
			should not be present</assert>
		<assert test="$CII-DT-041" flag="warning" id="CII-DT-041">[CII-DT-041] - BasisAmount should
			not be present</assert>
		<assert test="$CII-DT-042" flag="warning" id="CII-DT-042">[CII-DT-042] - UnitBasisAmount
			should not be present</assert>
		<assert test="$CII-DT-043" flag="warning" id="CII-DT-043">[CII-DT-043] -
			LineTotalBasisAmount should not be present</assert>
		<assert test="$CII-DT-044" flag="warning" id="CII-DT-044">[CII-DT-044] -
			AllowanceChargeBasisAmount should not be present</assert>
		<assert test="$CII-DT-049" flag="warning" id="CII-DT-049">[CII-DT-049] - CurrencyCode should
			not be present</assert>
		<assert test="$CII-DT-050" flag="warning" id="CII-DT-050">[CII-DT-050] - Jurisdiction should
			not be present</assert>
		<assert test="$CII-DT-051" flag="warning" id="CII-DT-051">[CII-DT-051] -
			CustomsDutyIndicator should not be present</assert>
		<assert test="$CII-DT-052" flag="warning" id="CII-DT-052">[CII-DT-052] - ExemptionReasonCode
			should not be present</assert>
		<assert test="$CII-DT-098" flag="warning" id="CII-DT-098">[CII-DT-098] - ExemptionReason
			should not be present</assert>
		<assert test="$CII-DT-053" flag="warning" id="CII-DT-053">[CII-DT-053] -
			TaxBasisAllowanceRate should not be present</assert>
		<assert test="$CII-DT-054" flag="warning" id="CII-DT-054">[CII-DT-054] - TaxPointDate should
			not be present</assert>
		<assert test="$CII-DT-055" flag="warning" id="CII-DT-055">[CII-DT-055] - Type should not be
			present</assert>
		<assert test="$CII-DT-056" flag="warning" id="CII-DT-056">[CII-DT-056] - InformationAmount
			should not be present</assert>
		<assert test="$CII-DT-057" flag="warning" id="CII-DT-057">[CII-DT-057] - CategoryName should
			not be present</assert>
		<assert test="$CII-DT-058" flag="warning" id="CII-DT-058">[CII-DT-058] - DueDateTypeCode
			should not be present</assert>
		<assert test="$CII-DT-059" flag="warning" id="CII-DT-059">[CII-DT-059] - @format should not
			be present</assert>
		<assert test="$CII-DT-060" flag="warning" id="CII-DT-060">[CII-DT-060] -
			SpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-DT-061" flag="warning" id="CII-DT-061">[CII-DT-061] -
			ServiceSupplyTradeCountry should not be present</assert>
		<assert test="$CII-DT-062" flag="warning" id="CII-DT-062">[CII-DT-062] -
			BuyerRepayableTaxSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-DT-063" flag="warning" id="CII-DT-063">[CII-DT-063] -
			SellerPayableTaxSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-DT-064" flag="warning" id="CII-DT-064">[CII-DT-064] -
			SellerRefundableTaxSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-DT-065" flag="warning" id="CII-DT-065">[CII-DT-065] -
			BuyerDeductibleTaxSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-DT-066" flag="warning" id="CII-DT-066">[CII-DT-066] -
			BuyerNonDeductibleTaxSpecifiedTradeAccountingAccount should not be present</assert>
		<assert test="$CII-DT-067" flag="warning" id="CII-DT-067">[CII-DT-067] -
			PlaceApplicableTradeLocation should not be present</assert>
	</rule>
	<rule context="$BillingSpecifiedPeriodType">
		<assert test="$CII-DT-068" flag="fatal" id="CII-DT-068">[CII-DT-068] - DateTime shall not be
			used.</assert>
		<assert test="$CII-DT-069" flag="fatal" id="CII-DT-069">[CII-DT-069] - DurationMeasure shall
			not be used.</assert>
		<assert test="$CII-DT-070" flag="fatal" id="CII-DT-070">[CII-DT-070] - InclusiveIndicator
			shall not be used.</assert>
		<assert test="$CII-DT-071" flag="fatal" id="CII-DT-071">[CII-DT-071] - Description shall not
			be used.</assert>
		<assert test="$CII-DT-072" flag="fatal" id="CII-DT-072">[CII-DT-072] - DateTime shall not be
			used.</assert>
		<assert test="$CII-DT-073" flag="fatal" id="CII-DT-073">[CII-DT-073] - CompleteDateTime
			shall not be used.</assert>
		<assert test="$CII-DT-074" flag="fatal" id="CII-DT-074">[CII-DT-074] - OpenIndicator shall
			not be used.</assert>
		<assert test="$CII-DT-075" flag="fatal" id="CII-DT-075">[CII-DT-075] - SeasonCode shall not
			be used.</assert>
		<assert test="$CII-DT-076" flag="fatal" id="CII-DT-076">[CII-DT-076] - ID shall not be
			used.</assert>
		<assert test="$CII-DT-077" flag="fatal" id="CII-DT-077">[CII-DT-077] - Name shall not be
			used.</assert>
		<assert test="$CII-DT-078" flag="fatal" id="CII-DT-078">[CII-DT-078] - SequenceNumeric shall
			not be used.</assert>
		<assert test="$CII-DT-079" flag="fatal" id="CII-DT-079">[CII-DT-079] -
			StartDateFlexibilityCode shall not be used.</assert>
		<assert test="$CII-DT-080" flag="fatal" id="CII-DT-080">[CII-DT-080] - ContinuousIndicator
			shall not be used.</assert>
		<assert test="$CII-DT-081" flag="fatal" id="CII-DT-081">[CII-DT-081] - PurposeCode shall not
			be used.</assert>
	</rule>
	<rule context="$PostalTradeAddressType">
		<assert test="$CII-DT-082" flag="fatal" id="CII-DT-082">[CII-DT-082] - ID shall not be
			used.</assert>
		<assert test="$CII-DT-083" flag="fatal" id="CII-DT-083">[CII-DT-083] - PostOfficeBox shall
			not be used.</assert>
		<assert test="$CII-DT-084" flag="fatal" id="CII-DT-084">[CII-DT-084] - BuildingName shall
			not be used.</assert>
		<assert test="$CII-DT-086" flag="fatal" id="CII-DT-086">[CII-DT-086] - LineFour shall not be
			used.</assert>
		<assert test="$CII-DT-087" flag="fatal" id="CII-DT-087">[CII-DT-087] - LineFive shall not be
			used.</assert>
		<assert test="$CII-DT-088" flag="fatal" id="CII-DT-088">[CII-DT-088] - StreetName shall not
			be used.</assert>
		<assert test="$CII-DT-089" flag="fatal" id="CII-DT-089">[CII-DT-089] - CitySubDivisionName
			shall not be used.</assert>
		<assert test="$CII-DT-090" flag="fatal" id="CII-DT-090">[CII-DT-090] - CountryName shall not
			be used.</assert>
		<assert test="$CII-DT-091" flag="fatal" id="CII-DT-091">[CII-DT-091] - CountrySubDivisionID
			shall not be used.</assert>
		<assert test="$CII-DT-092" flag="fatal" id="CII-DT-092">[CII-DT-092] - AttentionOf shall not
			be used.</assert>
		<assert test="$CII-DT-093" flag="fatal" id="CII-DT-093">[CII-DT-093] - CareOf shall not be
			used.</assert>
		<assert test="$CII-DT-094" flag="fatal" id="CII-DT-094">[CII-DT-094] - BuildingNumber shall
			not be used.</assert>
		<assert test="$CII-DT-095" flag="fatal" id="CII-DT-095">[CII-DT-095] - DepartmentName shall
			not be used.</assert>
		<assert test="$CII-DT-096" flag="fatal" id="CII-DT-096">[CII-DT-096] - AdditionalStreetName
			shall not be used.</assert>
	</rule>
	<rule context="$DateTimeString">
		<assert test="$CII-DT-097" flag="fatal" id="CII-DT-097">[CII-DT-097] - Date time string with
