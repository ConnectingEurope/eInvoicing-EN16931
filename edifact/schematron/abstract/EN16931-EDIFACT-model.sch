...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="EN16931">  
  ...
  <rule context="$Document_level_charges ">
    ...
    <assert test="$BR-40" flag="fatal" id="BR-40">[BR-40]-Document level charge base amounts shall not be negative. </assert>
  ...
  <rule context="$Invoice ">
    ...
    <assert test="$BR-O-01" flag="fatal" id="BR-O-01">[BR-O-01]-An Invoice that contains a line, a document level allowance or a document level  charge where the Invoiced item VAT category code (BT-151, BT-95 or BT-102) is “VAT Out of scope” shall contain in the VAT breakdown (BG-23) exactly one VAT category code (BT-118) equal with "Out of scope of VAT".</assert>
  ...
  <rule context="$Invoice_Line ">
    ...
    <assert test="$BR-DEC-22" flag="fatal" id="BR-DEC-22">[BR-DEC-22]-The allowed maximum number of decimals for the Invoiced quantity (BT-129) is 4.</assert>
    ...
    <assert test="$BR-DEC-30" flag="fatal" id="BR-DEC-30">[BR-DEC-30]-The allowed maximum number of decimals for the Item net price (BT-146) is 5.</assert>
    <assert test="$BR-DEC-31" flag="fatal" id="BR-DEC-31">[BR-DEC-31]-The allowed maximum number of decimals for the Item price discount (BT-147) is 5.</assert>
    <assert test="$BR-DEC-32" flag="fatal" id="BR-DEC-32">[BR-DEC-32]-The allowed maximum number of decimals for the Item gross price (BT-148) is 5.</assert>
    <assert test="$BR-DEC-33" flag="fatal" id="BR-DEC-33">[BR-DEC-33]-The allowed maximum number of decimals for the Item price base quantity (BT-149) is 4.</assert>
    <assert test="$BR-DEC-34" flag="fatal" id="BR-DEC-34">[BR-DEC-34]-The allowed maximum number of decimals for the Invoiced item VAT rate (BT-152) is 4.</assert>
  </rule>
  <rule context="$Invoice_line_allowances ">
    ...
    <assert test="$BR-42" flag="fatal" id="BR-42">[BR-42]-Each Invoice line allowance shall have an Invoice line allowance reason or an Invoice allowance reason code. </assert>
    ...
    <assert test="$BR-DEC-26" flag="fatal" id="BR-DEC-26">[BR-DEC-26]-The allowed maximum number of decimals for the Invoice line allowance percentage (BT-138) is 4.</assert>
  </rule>
  <rule context="$Invoice_line_charges ">
    ...
    <assert test="$BR-DEC-29" flag="fatal" id="BR-DEC-29">[BR-DEC-29]-The allowed maximum number of decimals for the Invoice line charge percentage (BT-143) is 4.</assert>
  </rule>
  ...
  <rule context="$VAT_breakdown ">
    ...
    <assert test="$BR-DEC-21" flag="fatal" id="BR-DEC-21">[BR-DEC-21]-The allowed maximum number of decimals for the VAT category rate (BT-119) is 4.</assert>
  </rule>
  ...
  <rule context="$VATAE ">
    ...
    <assert test="$BR-AE-09" flag="fatal" id="BR-AE-09">[BR-AE-09]-The VAT category tax amount (BT-117) in VAT breakdown (BG-23) where VAT category code (BT-118) is "VAT reverse charge" shall equal 0 (zero). </assert>
