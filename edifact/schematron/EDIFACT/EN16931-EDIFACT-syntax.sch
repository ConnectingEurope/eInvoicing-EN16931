...
<!-- Timestamp: 2016-07-12 00:05:00 +0200 -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="EN16931-SYNTAX" id="EN16931-EDIFACT-Syntax">
	...
	<param name="EDIFACT-SR-083" value="(not(current()[S_NAD/D_3035=('SE', 'PE')]/S_FII[D_3035='RB'])) 
		or (current()[S_NAD/D_3035='BY']/S_FII[D_3035='BI'])"/>
	...
	<param name="EDIFACT-SR-096" value="not(G_SG3/S_RFF) or 
						(current()[S_NAD/D_3035='SE']/G_SG3/S_RFF/C_C506[D_1153=('APA', 'VA', 'AHP', 'AII', 'AVS')]) or
						(current()[S_NAD/D_3035='BY']/G_SG3/S_RFF/C_C506[D_1153=('GN', 'VA')]) or
						(current()[S_NAD/D_3035='PE']/G_SG3/S_RFF/C_C506[D_1153=('GN', 'AAA', 'AVS')]) or
						(current()[S_NAD/D_3035='AE']/G_SG3/S_RFF/C_C506[D_1153='VA'])"/>
