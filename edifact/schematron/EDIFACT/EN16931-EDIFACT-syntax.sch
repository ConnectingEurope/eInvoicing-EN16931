...
<!-- Timestamp: 2016-07-27 22:50:00 +0200 -->
<!-- SG27/FTX -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="EN16931-SYNTAX" id="EN16931-EDIFACT-Syntax">
	...
	<!-- FTX -->
	<param name="EDIFACT-SR-035" value=".[D_4451='GEN' or D_4451='AHR' or D_4451='AFP' or D_4451='ADE' or D_4451='AGM' or D_4451='AAB']"/>
	...
	<param name="EDIFACT-SR-083" value="(not(.[S_NAD/D_3035=('SE', 'PE')]/S_FII[D_3035='RB'])) 
		or (.[S_NAD/D_3035='BY']/S_FII[D_3035='BI'])"/>
	...
	<param name="EDIFACT-SR-090" value="S_FII[D_3035='BI']/C_C078/D_3192 or not (S_FII/C_C078/D_3192)"/>
	...
	<param name="EDIFACT-SR-096" value="not(G_SG3/S_RFF) or 
						(.[S_NAD/D_3035='SE']/G_SG3/S_RFF/C_C506[D_1153=('APA', 'VA', 'AHP', 'AII', 'AVS')]) or
						(.[S_NAD/D_3035='BY']/G_SG3/S_RFF/C_C506[D_1153=('GN', 'VA')]) or
						(.[S_NAD/D_3035='PE']/G_SG3/S_RFF/C_C506[D_1153=('GN', 'AAA', 'AVS')]) or
						(.[S_NAD/D_3035='AE']/G_SG3/S_RFF/C_C506[D_1153='VA'])"/>
	<param name="EDIFACT-SR-097" value="not(G_SG4)"/>
	<param name="EDIFACT-SR-098" value="not(G_SG5) or G_SG5[S_CTA/D_3139='SU']/S_COM/C_C076[D_3155='EM']/D_3148 
		"/>
	<param name="EDIFACT-SR-099" value="not(G_SG5/S_CTA/C_C056/D_3413)"/>
	<!-- SG7 -->
	<param name="EDIFACT-SR-100" value="(S_CUX/C_C504/D_6347='3' and S_CUX/C_C504/D_6347='18') or (S_CUX/C_C504/D_6347='2' and S_CUX/C_C504/D_6347='4')"/>
	...
	<!-- SG8 -->
	<param name="EDIFACT-SR-106" value="(.[S_PYT/D_4279='3' and S_PYT/D_2475='66' and S_PYT/D_2009='1']/S_DTM/C_C507[D_2005='13' and D_2379='102']/D_2380 and not(S_PAI))
	...
	<param name="EDIFACT-SR-164" value="S_PIA[D_4347 = '1']"/>
	...
	<param name="EDIFACT-SR-172" value="S_IMD[D_7077='F' and C_C272/D_7081='57'] or S_IMD[D_7077='A']"/>
	...
	<param name="EDIFACT-SR-195" value="not(S_FTX) or (S_FTX[D_4451=('ACB', 'AGM') and D_4453='1']/C_C108/D_4440) or ((S_FTX[D_4451='ACF' and D_4453='1']/C_C108/D_4440) and (S_FTX[D_4451='ACF' and D_4453='1']/C_C108/D_4440_2))"/>
	...
	<param name="EDIFACT-SR-218" value="not(G_SG31/S_RFF/C_C506[D_1153=('LI','AWQ')]/D_1154)"/>
	<param name="EDIFACT-SR-219" value="not(G_SG31/S_RFF/C_C506[D_1153!='LI']/D_1156)"/>
	...
	<!-- SG52 -->
	<param name="EDIFACT-SR-271" value="S_MOA/C_C516[D_5025 = ('9', '11', '79', '176', '259', '260', '388', '389')]/D_5004"/>
	...
	<param name="EDIFACT-SR-276" value="(
		...
		(
		 (S_TAX[D_5283='7' and C_C241/D_5153='VAT']) and 
		 (S_MOA/C_C516[D_5025 = '2']/D_5004) and 
		 (S_MOA/C_C516[D_5025 = '2']/D_6345)
		)"/>
