...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="EN16931" id="EN16931-EDIFACT-Model">
  ...
  <param name="BR-S-10" value="(not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C108/D_4440) and not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C107/D_4441)) or (/M_INVOIC/G_SG54/S_TAX[D_5305=('AE','E','O','IC','G')])"/>
  <param name="BR-AF-01" value="((count(/M_INVOIC/G_SG27/G_SG35/S_TAX[D_5305='AF']) + count(/M_INVOIC/G_SG54/S_TAX[D_5305='AF'])) &gt;=2 or not (/M_INVOIC/G_SG27/G_SG35/S_TAX[D_5305='AF'])) and 
    ((count(/M_INVOIC/G_SG16/G_SG22/S_TAX[D_5305='AF']) + count(/M_INVOIC/G_SG54/S_TAX[D_5305='AF'])) &gt;=2 or not (/M_INVOIC/G_SG16/G_SG22/S_TAX[D_5305='AF']))"/>
  ...
  <!-- only possible check: If an invoice only included VAT category 'S' or 'Z' or 'O' or 'AF' or 'AG' there should be no VAT exemption reason text given -->
  <param name="BR-AF-10" value="(not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C108/D_4440) and not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C107/D_4441)) or (/M_INVOIC/G_SG54/S_TAX[D_5305=('AE','E','O','IC','G')])"/>
  <param name="BR-AG-01" value="((count(/M_INVOIC/G_SG27/G_SG35/S_TAX[D_5305='AG']) + count(/M_INVOIC/G_SG54/S_TAX[D_5305='AG'])) &gt;=2 or not (/M_INVOIC/G_SG27/G_SG35/S_TAX[D_5305='AG'])) and 
    ((count(/M_INVOIC/G_SG16/G_SG22/S_TAX[D_5305='AG']) + count(/M_INVOIC/G_SG54/S_TAX[D_5305='AG'])) &gt;=2 or not (/M_INVOIC/G_SG16/G_SG22/S_TAX[D_5305='AG']))"/>
  ...
  <!-- only possible check: If an invoice only included VAT category 'S' or 'Z' or 'O' or 'AF' or 'AG' there should be no VAT exemption reason text given -->
  <param name="BR-AG-10" value="(not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C108/D_4440) and not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C107/D_4441)) or(/M_INVOIC/G_SG54/S_TAX[D_5305=('AE','E','O','IC','G')])"/>
  ...
  <param name="BR-Z-10" value="(not(/M_INVOIC/S_FTX[D_4451='AGM']/C_C108/D_4440)
                                   ...
                                   or(/M_INVOIC/G_SG54/S_TAX[D_5305=('AE','E','O','IC','G')])"/>
